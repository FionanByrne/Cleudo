...
public class IDontKnow1 implements BotAPI {
    ...
    private String name = "IDontKnow1";
    private Room destination;
    private boolean turnOver = false;
    

    public IDontKnow1 (Player player, PlayersInfo playersInfo, Map map, Dice dice, Log log, Deck deck) {
        this.player = player;
