...
public class IDontKnow3 implements BotAPI {
    ...
    private String name = "IDontKnow3";
    private Room destination;
    private boolean turnOver = false;
    

    public IDontKnow3 (Player player, PlayersInfo playersInfo, Map map, Dice dice, Log log, Deck deck) {
        this.player = player;
